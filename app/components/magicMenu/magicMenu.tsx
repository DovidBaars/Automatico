...
import { UseDraggableChildProps } from '@/components/useDraggable/interface';

const MagicMenu: React.FC<MagicMenuProps> = (props) => {
    const { isPressed, setIsPressed, triggerText, renderComponent } = props as MagicMenuProps & UseDraggableChildProps;
