      ...
      <tbody>
        {tests.map((test, index) => (
          <tr key={index}>
            ...
            <td>
              <button type='button' className={styles.runBtn} onClick={() => TestService.runTest(test.name)}>Run</button>
            </td>
            <td>
              <button type='button' className={styles.deleteBtn} onClick={() => TestService.deleteTest(test.name)}>Delete</button>
            </td>
          </tr>
        ))}
      </tbody>
